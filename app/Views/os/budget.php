...
<body>
    ...
    <main class="container-fluid pt-3">
        <header class="text-center">
            ...
            <p class="lead">Utilize o formulário abaixo para visualizar as ordens de serviço que aguardam orçamento.</p>
        </header>
        <div class="table-responsive small rounded p-2 mb-3 bg-body">
            <table id="tabela" class="table table-hover table-sm pb-2">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr class="p-2">
                        <td class="p-2"><a class="link-dark link-underline link-underline-opacity-0" href="os/budget/details?id=<?php echo $os['id'];?>"><?php echo $os['created_at'];?></td>
                        <td class="p-2"><a class="link-dark link-underline link-underline-opacity-0" href="os/budget/details?id=<?php echo $os['id'];?>"><?php echo $os['id'];?></td>
                        <td class="p-2"><a class="link-dark link-underline link-underline-opacity-0" href="os/budget/details?id=<?php echo $os['id'];?>"><?php echo $os['cliente'];?></td>
                        <td class="p-2"><a class="link-dark link-underline link-underline-opacity-0" href="os/budget/details?id=<?php echo $os['id'];?>"><?php echo $os['equipamento'];?></td>
                        <td class="p-2"><a class="link-dark link-underline link-underline-opacity-0" href="os/budget/details?id=<?php echo $os['id'];?>">
                        ...
                        <td class="p-2"><a class="link-dark link-underline link-underline-opacity-0" href="os/budget/details?id=<?php echo $os['id'];?>"><?php echo $os['n_dias'];?></td>
                        <td class="p-2"><a class="link-dark link-underline link-underline-opacity-0" href="os/budget/details?id=<?php echo $os['id'];?>"><?php echo $os['valor_total'];?></td>
                        <td class="p-2">
                            <a class="link-dark link-underline link-underline-opacity-0" href="os/budget/details?id=<?php echo $os['id'];?>">
                                <div class="form-check d-flex justify-content-center">
            ...
            <ul class="pagination pt-3">
                <?php foreach($navigation as $navItem): ?>
                    <li class="page-item<?php if(!$navItem['active']) echo " disabled"; ?>">
                        <a class="page-link link-dark" href="/os/budget?page=<?php echo $navItem['page']; ?>">
