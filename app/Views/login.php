...
<head>
    ...
    <title>Hyper Computer - Login</title>
...
<body class="text-center" data-bs-theme="light">
<main class="form-signin">
    <form class="needs-validation" novalidate method="POST" action="/login">
        ...
        <h1 class="h3 mb-3 fw-normal pb-4"><strong>Login</strong></h1>
        ...
        <div class="form-floating">
            <input type="password" class="form-control" id="floatingPassword" name="senha" placeholder="Informe sua senha" required>
    ...
    <p><a href="/forgot_password">Esqueci minha senha</a></p>
</main>
