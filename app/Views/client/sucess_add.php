...
<head>
    ...
    <title>Cliente - Ordens de Serviço</title>
...
<main class="form-signin">
    <h1 class="h3 mb-3 fw-normal pb-4"><strong>Cliente cadastrado com sucesso!</strong></h1>
    <p><a href="/user/dashboard">Cadastrar n</a></p>
